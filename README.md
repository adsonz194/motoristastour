...
- Toda transição gera histórico com data, responsável, estado anterior e novo estado. Alterações de rota também ficam destacadas com o nome e a conta de quem executou, perfil, tour, consultor, rota anterior → nova e todos os motoristas afetados. Um motorista só consegue avançar a rota de um tour do qual participa; na Casa, somente quem permaneceu com a família pode movê-la. O administrador mantém acesso para corrigir qualquer rota.
