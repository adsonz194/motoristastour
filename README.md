...
- A localização exata só é compartilhada após uma ação do próprio motorista, durante um check-in ativo e antes das 15:00 no fuso `America/Bahia`. Às 15:00, novos envios são recusados e as posições existentes são removidas. O mapa global é exclusivo da Hostess autenticada; o consultor recebe no máximo o ponto do motorista que assumiu o seu próprio pedido, mediante a credencial temporária desse pedido. Não há histórico do trajeto.
