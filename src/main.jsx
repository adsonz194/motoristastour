...
const actionMeta = {
  ...
  'assign-destination': { title: 'Assumir destino final', text: 'Selecione os motoristas disponíveis para o destino. Um carrinho será reservado automaticamente para cada um.', label: 'Assumir destino', allocations: true },
...
function ActionModal({ tour, action, data, user, onClose, token, refresh, notify }) {
  ...
  const [allocations, setAllocations] = useState(() => meta.allocations ? [{ driverId: '' }] : []);
